    ...
    function register_sections_fields()
    {
        ...
        add_settings_field(
            ...
            array(
                ...
                'field_slug'             => $field_slug,
                'field_name'             => ASENHA_SLUG_U . '[' . $field_id . ']',
                'field_description'      => 'Force all links to external sites in post content to open in new browser tab via target="_blank" attribute. The rel="noopener noreferrer nofollow" attribute will also be added for enhanced security and SEO benefits.',
        ...
        $field_description = 'Use a shortcode like the following example to display an email address on the frontend of your site: [obfuscate email="john@mysite.com"]. Add the <strong>display="inline"</strong> parameter if you want the email inlined.';
        add_settings_field(
            $field_id,
            // Field ID
            '',
        ...
        add_settings_field(
            ...
            array(
                'option_name'       => ASENHA_SLUG_U,
                'field_description' => '<div class="asenha-warning"><strong>If something goes wrong</strong> and you need to regain access to your account as an administrator, please visit the following URL: <br /><strong>' . get_site_url( null, '/?reset-for=' ) . $current_user_username . '</strong></div>',
                'class'             => 'asenha-description utilities ' . $field_slug,
            )
        );
        ...
        add_settings_field(
            ...
            array(
                ...
                'field_slug'            => $field_slug,
                'field_name'            => ASENHA_SLUG_U . '[' . $field_id . ']',
                'field_description'     => 'Show quick summary of the system the site is running on to admins, in the "At a Glance" dashboard widget. This includes the web server software, the PHP version, and the database software.',
                'field_options_wrapper' => true,
                'class'                 => 'asenha-toggle utilities ' . $field_slug,
            )
        );
